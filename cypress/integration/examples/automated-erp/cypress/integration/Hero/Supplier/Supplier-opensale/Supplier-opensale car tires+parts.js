...
context("Open-Sale", () => {
    ...
    it("Open-Sale car tires+parts", () => {
        loginsupplier("grip-member1", "password")
        Opensale()

        //รายละเอียดของสินค้า ยาง
        Detail1()
        Detail2()
...
const checksupplieropenorder = () => {
    ...
    cy.get('.table-order-wrappe > .table > thead > tr > :nth-child(3)')
        .should("contain.text", "ราคาต่อหน่วย")
    cy.get('.table-order-wrappe > .table > tbody > :nth-child(2) > :nth-child(3)')
        .should("contain.text", "200.00")
    ...
    cy.get('.table-order-wrappe > .table > tbody > :nth-child(5) > :nth-child(3)')
...
const receiveSale = () => {
    ...
    // กรอกจำนวนและ dot ที่รับสินค้า ยาง
