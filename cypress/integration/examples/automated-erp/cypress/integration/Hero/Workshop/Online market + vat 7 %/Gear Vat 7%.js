...
const orderOnlineGear1 = () => {
  ...
  cy.get(":nth-child(4) > .three").contains("107.52 บาท");
  cy.get(".total-price").contains("1,643.52 บาท");
...
const checkorderOnlineGear = () => {
  ...
  cy.get("#totalNettd").contains("1,643.52 บาท");
...
const supplierreceive = () => {
  ...
  cy.get(":nth-child(4) > .text-right").contains("1,643.52 บาท");
